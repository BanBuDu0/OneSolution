...
verify_base = pd.read_csv("D:\\jupyter_project\\OneSolution\\data\\fake_data\\base_test_sum.csv", encoding="gbk")
verify_money = pd.read_csv("D:\\jupyter_project\\OneSolution\\data\\fake_data\\money_report_test_sum.csv",
                           encoding="gbk")
verify_knowledge = pd.read_csv("D:\\jupyter_project\\OneSolution\\data\\fake_data\\knowledge_test_sum.csv",
                               encoding="gbk")
verify_year = pd.read_csv("D:\\jupyter_project\\OneSolution\\data\\fake_data\\year_report_test_sum.csv", encoding="gbk")
